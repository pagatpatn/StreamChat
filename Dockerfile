...
# Install Chromium + ChromeDriver + dependencies for Selenium
RUN apt-get update && apt-get install -y \
    chromium chromium-driver wget unzip curl \
    libnss3 libgconf-2-4 libx11-xcb1 libxcomposite1 libxcursor1 \
    libxdamage1 libxi6 libxtst6 libxrandr2 libasound2 libatk1.0-0 \
    libatk-bridge2.0-0 libcups2 libdbus-1-3 libgtk-3-0 libxss1 \
